...
I use [Mochi](https://mochi.cards/) for flashcards. I have built a script to automatically generate flashcards whenever these notes are updated.

You can download all the flashcards to import into Mochi. You'll need to redownload and import it whenever there are changes.
...
> [!INFO] If you'd like to use the script I wrote for your own notes, [it is on my Github](https://github.com/0x62/obsidian2mochi)
